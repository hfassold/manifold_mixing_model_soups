# I do NOT install 'ImageNetV2_pytorch' via pip from https://github.com/modestyachts/ImageNetV2_pytorch,
# because I have to modify it slightly (for python >= 3.9,
# in the 'glob' function the default for 'recursive' has changed ...)

# So this is the modified version, which works for all python versions
...
class ImageNetValDataset(Dataset):
    def __init__(self, transform=None, location="."):
        ...
        # FAH: Modified 'glob' call - added parameter 'recursive=True'
        # This param was set per default to 'True' for python versions < 3.9, and to False for python versions >= 3.9
        # So that means the (original, unmodified) class given here works only for Python < 3.9 :-(
        ...
        self.fnames = list(self.dataset_root.rglob("**/*.JPEG"))
