# FAH: This version of 'main.py' still includes evaluations also on objectnet ...
...
if __name__ == '__main__':
    ...
    if args.eval_individual_models:
        ...
        for j, model_path in enumerate(model_paths):
            ...
            datasetList = [ImageNet2p, ImageNet, ImageNetV2, ImageNetSketch, ImageNetR, ObjectNet, ImageNetA]
    ...
    if args.greedy_soup:
        ...
        for i in range(1, NUM_MODELS):
            ...
            # ('ImageNet2p' in the code) takes roughly 30 seconds (on my ML PC)
            # ~FAH
